...
const PAGE_META: Record<string, { label: string; path: string; hint: string }> = {
  ...
  terms: { label: 'Terms of Service', path: '/terms', hint: 'The copy itself lives under Content → Legal pages.' },
  privacy: { label: 'Privacy Policy', path: '/privacy', hint: 'The copy itself lives under Content → Legal pages.' },
  delivery: { label: 'Delivery', path: '/delivery', hint: 'Delivery areas, times and charges.' },
  returns: { label: 'Returns & Refunds', path: '/returns', hint: 'Return window and refund timing.' },
