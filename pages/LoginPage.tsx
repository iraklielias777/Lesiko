      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 sm:p-12 lg:p-24 relative">
        ...
        <div className="max-w-sm w-full mx-auto">
          <div className="mb-10">
            ...
            <p className="text-gray-500">{t('auth.signInTitle')}</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="flex justify-end mt-2">
                <Link to="/forgot-password" className="text-xs font-medium text-gray-500 hover:text-brand-green transition-colors">
