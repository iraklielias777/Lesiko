            ...
            {activeTab === 'orders' && (
              <div className="space-y-6 animate-fade-in">
                 ...
                 {orderList.length === 0 ? (
                    ...
                    orderList.map((order) => (
                        <div key={order.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow group mb-4">
                                ...
                                <div className="mt-4 space-y-2">
                                    {order.items.map((item, idx) => (
                                        <div key={idx} className="flex justify-between text-sm">
                                            ...
                                            <button onClick={() => handleBuyAgain(item)} className="text-brand-green font-bold">Buy Again</button>
                                        </div>
                                    ))}
                                </div>
                            </div>
